...
parser = argparse.ArgumentParser(description='Throughput x Time.',
...
gconfig = {
    ...
    'mkv-lines': {
        'SrcBW': {'ls': '-', 'lw': 1.2, 'marker': 'x', 'ms': 5, 'color': 'xkcd:light blue', 'label': 'MKV-Get'},
        'InsBW': {'ls': '-', 'lw': 1.2, 'marker': '*', 'ms': 5, 'color': 'xkcd:blue', 'label': 'MKV-Set'},
        'SrcInsBW': {'ls': '-', 'lw': 1.2, 'marker': 'o', 'ms': 3, 'color': 'xkcd:dark blue', 'label': 'MKV-Tot'},
    },
    'ldb-lines': {
        'SrcBW': {'ls': '-', 'lw': 1.2, 'marker': 'x', 'ms': 5, 'color': 'xkcd:light red', 'label': 'LDB-Get'},
        'InsBW': {'ls': '-', 'lw': 1.2, 'marker': '*', 'ms': 5, 'color': 'xkcd:red', 'label': 'LDB-Set'},
        'SrcInsBW': {'ls': '-', 'lw': 1.2, 'marker': 'o', 'ms': 3, 'color': 'xkcd:dark red', 'label': 'LDB-Tot'},
    },
